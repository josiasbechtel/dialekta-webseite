...
export const offers = [
  {
    ...
    points: ['Einstieg ohne Vorwissen', 'Alltag, Büro und Organisation', 'Datenschutz und Faktencheck', 'Live online, vor Ort oder hybrid'],
  ...
  },
  {
    ...
    text: 'Der KI-Telefonagent nimmt Anrufe rund um die Uhr entgegen, erkennt Anliegen und fasst Informationen sauber per Mail zusammen.',
    points: ['24/7 erreichbar', 'Schweizerdeutsch', 'über 30 Sprachen', 'ohne neue Hardware'],
    cta: 'Telefonagent ansehen',
    icon: 'phone',
  },
  {
    ...
    points: ['mehr Übersicht', 'weniger Handarbeit', 'passend zur Aufgabe', 'schnell testbar'],
    cta: 'Arbeitshelfer ansehen',
    icon: 'grid',
  },
]
