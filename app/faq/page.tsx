...
export default function FaqPage() {
  return (
    <PageFrame pageClass="page-faq">
      <Hero visual="faq" image="/assets/img/hero-home-v2.png" title={<>Häufige Fragen<br />zu Dialekta.</>} lead="Kurz, verständlich und auf die wichtigsten Entscheidungen fokussiert." actions={[{ href: '/analysegespraech', label: 'Analysegespräch sichern' }]} />
