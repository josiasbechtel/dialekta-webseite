...
export default function UeberUnsPage() {
  return (
    <PageFrame pageClass="page-ueber-uns">
      <Hero visual="about" image="/assets/img/hero-ueber-uns-v2.png" title={<>KI soll entlasten.<br />Nicht komplizierter machen.</>} lead="Dialekta wurde von Josias Bechtel und Martin Wichmann gegründet. Wir setzen KI so ein, dass sie Menschen im Alltag wirklich unterstützt." actions={[{ href: '/analysegespraech', label: 'Analysegespräch sichern' }]} />
