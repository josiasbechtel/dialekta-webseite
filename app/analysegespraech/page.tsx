...
export default function AnalysePage() {
  return (
    <PageFrame pageClass="page-analysegespraech">
      <Hero image="/assets/img/hero-analysegespraech-v2.png" title={<>Finde deine<br />passende KI-Lösung.</>} lead="Im kostenlosen Analysegespräch finden wir gemeinsam heraus, welche KI-Lösung dir aktuell am meisten Entlastung bringt." actions={[{ href: '#kontakt', label: 'Analysegespräch auswählen' }]} />
