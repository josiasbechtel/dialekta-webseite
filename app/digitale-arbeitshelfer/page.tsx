...
export default function DigitaleArbeitshelferPage() {
  return (
    <PageFrame pageClass="page-digitale-arbeitshelfer">
      <Hero visual="helpers" image="/assets/img/hero-home-v3.svg?v=20260609-digital-helpers" title={<>Digitale Helfer.<br />Mehr Übersicht.</>} lead="Für Betriebe, Teams und Vereine, die mit Anfragen, Listen, Kursen, Freigaben oder Übersichten weniger Aufwand haben möchten." actions={[{ href: '/analysegespraech', label: 'Digitale Lösung besprechen' }, { href: '#beispiele', label: 'Beispiele ansehen', outline: true }]} />
